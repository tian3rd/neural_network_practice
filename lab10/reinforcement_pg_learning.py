...
def finish_episode():
    ...
    for r in policy_net.rewards[::-1]:
        R = #FILL IN - how does the total reward at the current timestep (R) relate to the reward from the previous time step (R - the previous value) and the current reward r?
        rewards.insert(0, R)
