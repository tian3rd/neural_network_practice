...
def optimize_model():
    ...
    # Compute Huber loss
    loss = F.smooth_l1_loss(#FILL IN - what is the output and the target when we're calculating the loss - see slide 36 of the RL lecture for a hint, NOTE you need .unsqueeze(1) at the end of the target to get the shape right)
...
#The overall resulting data flow.
#
